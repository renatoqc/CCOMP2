...
// Definimos una estructura para almacenar estadísticas
struct Estadisticas {
    int fuerza;
    int agilidad;
    int inteligencia;
...
public:
    Heroe(string nombre, string historia, Estadisticas estadisticas) : nombre(nombre), historia(historia), estadisticas(estadisticas) {
    }
